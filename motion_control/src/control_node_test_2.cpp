...
public:
  ...
  // scan_start, scan_end, screw_start, scan_start_new, screw_start_new
  ...
  void execute_pipeline ()
  {
    ...
    std_srvs::Empty msg;
    std::cout << "1, set the robot pose to scan_start_new" << std::endl;
    if ( set_pose ( "scan_start_new" ) )
    {
      ...
      // step 4, move back to pose scan_start_new
      std::cout << "4, set the robot pose back to scan_start_new and then screw_start_new" << std::endl;
      if ( set_pose ( "scan_start_new" ) )
      {
        set_pose ( "screw_start_new" );
        ...
        // step 7, set the robot pose back to pose screw_start_new
        std::cout << "7, set the robot pose back to pose screw_start_new" << std::endl;
        set_pose ( "screw_start_new" );
      }
    }
  }
